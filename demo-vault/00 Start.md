...
**How to see it:** open [Shared topic](<./Materials/01 Backlink full path/Shared topic.md>), then open the **Backlinks** pane (the link icon in the right sidebar, or the "Backlinks" view). Three notes all named `Meeting` link here - with the plugin enabled, each backlink shows its full folder path.
